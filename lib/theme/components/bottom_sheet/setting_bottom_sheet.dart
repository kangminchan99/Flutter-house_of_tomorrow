...
import 'package:houseoftomorrow/theme/components/bottom_sheet/base_bottom_sheet.dart';
import 'package:houseoftomorrow/theme/components/tile.dart';
...
class SettingBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final LangService langService = context.watch<LangService>();
